...
事件链接回到首次展开该事件的正文；同一事件在不同国家或专题中的后续讨论，可由正文中的中文链接继续追踪。图件链接直达相应的时间线、空间示意或制度图，图上位置与边界均须按图注理解为阅读用的约略关系。若要辨认某一叙事使用的是经年、后出叙事、金文、简牍还是考古材料，请参看\hyperref[app:sources]{“来源与史料说明”}；材料分歧会实质改变读法的十个案例，集中在\hyperref[app:controversies]{“争议怎样改变周秦史的读法”}。跨卷追踪中央与地方、动员、继承、边疆和材料问题，则参看\hyperref[app:series-roadmap]{“书系路线图”}。

...
事件链接回到首次展开该事件的正文；同一事件在不同国家或专题中的后续讨论，可由正文中的中文链接继续追踪。图件链接直达相应的时间线、空间示意或制度图，图上位置与边界均须按图注理解为阅读用的约略关系。若要辨认某一叙事使用的是经年、后出叙事、金文、简牍还是考古材料，请参看\hyperref[app:sources]{“来源与史料说明”}及其中的\hyperref[app:bibliography]{“基础书目与读法索引”}；材料分歧会实质改变读法的十个案例，集中在\hyperref[app:controversies]{“争议怎样改变周秦史的读法”}。跨卷追踪中央与地方、动员、继承、边疆和材料问题，则参看\hyperref[app:series-roadmap]{“书系路线图”}。
...
\begin{description}
  \item[早周王命、受命与礼制语言] \hyperref[src:western-texts]{《尚书》《诗经》}，并与\hyperref[src:excavated]{金文、城址和墓葬材料}交读；可由\eventref{WZ-1046-MUYE}{西周·牧野}、\eventref{WZ-1040-DONGZHENG}{西周·三监东征}与\eventref{WZ-0841-GONGHE}{西周·共和}回到具体的证据边界。
  \item[春秋年次、会盟与国别叙事] \hyperref[src:chunqiu]{《春秋》}提供鲁国经年骨架；\hyperref[src:zuozhuan-guoyu]{《左传》《国语》及三传}提供须加辨析的叙事与经学解释。与\eventref{SA-0632-CHENGPU}{春秋·城濮之战}、\eventref{SA-0506-BOJU}{春秋·柏举之战}和\eventref{SA-0481-END}{春秋·记事终点}并读时，不能把传世说辞当作现场记录。
  \item[战国、秦的国家线与编年] \hyperref[src:shiji]{《史记》}、\hyperref[src:bamboo-annals-zizhi]{《竹书纪年》《资治通鉴》}和\hyperref[src:warring-texts]{《战国策》及法家、制度文本}各自承担不同的问题；\eventref{WQ-0356-SHANGYANG}{战国·商鞅变法}、\eventref{WQ-0260-CHANGPING}{战国·长平之战}与\eventref{QIN-0209-CHENSHENG}{秦·大泽起事}的正文说明了它们不可互相替代的原因。
  \item[出土材料、空间与行政] \hyperref[src:excavated]{金文、盟书、简牍与考古报告}可检验称谓、文书、地方行政和空间条件；它们不能由局部样本推出全国同步执行。相关的空间阅读入口见\hyperref[fig:vol01:western-zhou:chengzhou]{成周网络图}、\hyperref[fig:vol01:spring-autumn:chengpu]{城濮战役图}和\hyperref[fig:vol01:warring-qin:qin-unification]{秦统一六国图}。
  \item[通史、制度问题与古文阅读] \hyperref[src:interpretive]{钱穆、吕思勉与《中国史纲》}只作为提问与长线解释的入口；\hyperref[src:guwen-guanzhi]{《古文观止》}只作原典阅读的选本入口。两者均不承担逐年事实、精确数字或人物动机的证明。
  \item[跨卷正史与专门材料] \hyperref[app:bibliography]{“书系正史骨架”}列出二十四史及清代的接续材料，并说明各卷仍须锁定具体版本、专门编年和档案路径。
\end{description}
...
以下只列已由正文实际置入的十四张图件；目录中尚未置入正文的独立图文件不在此索引，以免目录链接到读者无法抵达的材料。

\begin{description}
  \item[西周] \hyperref[fig:vol01:western-zhou:timeline]{“时间线：从牧野到东迁”}；\hyperref[fig:vol01:western-zhou:overview-map]{“空间总览：王畿、东方与边疆”}；\hyperref[fig:vol01:western-zhou:muye]{“牧野战事空间示意”}；\hyperref[fig:vol01:western-zhou:chengzhou]{“宗周、成周与东方网络示意”}；\hyperref[fig:vol01:western-zhou:zhao-southern-routes]{“昭王南向行动与汉水风险示意”}。
  \item[春秋] \hyperref[fig:vol01:spring-autumn:states-overview]{“空间总览：诸侯怎样围绕中原展开”}；\hyperref[fig:vol01:spring-autumn:xuge]{“繻葛之战空间示意”}；\hyperref[fig:vol01:spring-autumn:chengpu]{“城濮战役空间示意”}；\hyperref[fig:vol01:spring-autumn:boju]{“柏举战役空间示意”}；\hyperref[fig:vol01:spring-autumn:qin-jin-xiao-corridor]{“秦、晋、郑与崤函通道示意”}；\hyperref[fig:vol01:spring-autumn:zheng-between-jin-chu]{“郑在晋楚竞争之间的走廊示意”}；\hyperref[fig:vol01:spring-autumn:song-mibing-dual-network]{“宋地弭兵与晋楚双重网络示意”}；\hyperref[fig:vol01:spring-autumn:qi-huan-alliance-network]{“齐桓公时期的会盟网络示意”}。
  \item[战国与秦] \hyperref[fig:vol01:warring-qin:seven-states]{“空间总览：七国竞争与秦的东进通道”}；\hyperref[fig:vol01:warring-qin:reform-network]{“战国变法关系示意”}；\hyperref[fig:vol01:warring-qin:changping]{“长平战场空间示意”}；\hyperref[fig:vol01:warring-qin:yan-qi]{“燕伐齐空间示意”}；\hyperref[fig:vol01:warring-qin:qin-unification]{“秦统一六国空间示意”}；\hyperref[fig:vol01:warring-qin:yique-hangu-corridor]{“伊阙—函谷走廊示意”}；\hyperref[fig:vol01:warring-qin:chu-eastward-court]{“楚都东迁与南方纵深示意”}；\hyperref[fig:vol01:warring-qin:qin-commandery-road-hubs]{“统一后咸阳、道路与郡县节点示意”}。
\end{description}

...
本索引选择回到首次深描的事件节点。每一条路由都由事件通向政权、主题、来源或图件，并可从相应附录再回到叙事；它不是一份逐条年表。可由\hyperref[app:index:sources]{来源索引}进入材料版本与边界，再回到事件；也可由\hyperref[app:index:figures]{图件索引}进入空间问题后回到同一批叙事锚点。
...
\begin{description}
  \figureindexentry{fig:vol02b:period-timeline}{三国至西晋统一的共同时间轴（220--280年）；见\eventref{EH-0220-HAN-ABDICATION}{汉魏禅代}与\eventref{TK-0280-SUN-HAO-SURRENDER}{孙皓出降}}
  \figureindexentry{fig:vol02b:polity-corridors}{三国政治中心与主要竞争走廊；见\eventref{TK-0222-YILING}{夷陵}与\eventref{TK-0229-SUN-QUAN-EMPEROR}{孙权称帝}}

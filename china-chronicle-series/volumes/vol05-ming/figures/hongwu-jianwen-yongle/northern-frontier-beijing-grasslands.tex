\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\bfseries,text=source] at (9.75,5.55) {草原诸部与北元活动空间（约略）};
    ...
    \node[steppe] (tumu) at (6.7,4.55) {土木、怀来一带\\1449年危机节点};
    ...
    \draw[->,very thick,color=source!85] (mongolia) -- node[right,note]
      {南下、使节与互市的不同路径} (tumu);
    \draw[->,thick,dashed,color=source!85] (tumu) -- node[left,note]
      {危机冲击北京防务} (beijing);
  ...
  \end{tikzpicture}
  \caption{明初至土木之变前后的北方前沿与北京节点（示意）。北平改称北京、北方军政经营以及1449年土木危机可据《明太宗实录》永乐元年正月条、《明英宗实录》正统十四年七月至八月条与《明史》相关本纪、兵志互校；草原诸部、边镇和卫所的行动范围、人数与控制关系，则须分别参照边报、地方志和对方材料。图中路线与分区仅显示北京、边镇和草原接触地带之间的关系，非比例地图，亦不构成任何时期的疆界复原。}
